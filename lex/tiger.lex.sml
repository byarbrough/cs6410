...
fun yyAction25 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.TYPE(!lineNum, hd(!linePos))))
fun yyAction26 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.VAR(!lineNum, hd(!linePos))))
fun yyAction27 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.FUNCTION(!lineNum, hd(!linePos))))
fun yyAction28 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.BREAK(!lineNum, hd(!linePos))))
fun yyAction29 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.OF(!lineNum, hd(!linePos))))
fun yyAction30 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.END(!lineNum, hd(!linePos))))
fun yyAction31 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.IN(!lineNum, hd(!linePos))))
fun yyAction32 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.NIL(!lineNum, hd(!linePos))))
fun yyAction33 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.LET(!lineNum, hd(!linePos))))
fun yyAction34 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.DO(!lineNum, hd(!linePos))))
fun yyAction35 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.TO(!lineNum, hd(!linePos))))
fun yyAction36 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.FOR(!lineNum, hd(!linePos))))
fun yyAction37 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.WHILE(!lineNum, hd(!linePos))))
fun yyAction38 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.ELSE(!lineNum, hd(!linePos))))
fun yyAction39 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.THEN(!lineNum, hd(!linePos))))
fun yyAction40 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.IF(!lineNum, hd(!linePos))))
fun yyAction41 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.ARRAY(!lineNum, hd(!linePos))))
fun yyAction42 (strm, lastMatch : yymatch) = (yystrm := strm;
      (Tokens.ASSIGN(!lineNum, hd(!linePos))))
fun yyAction43 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.INT(yytext, !lineNum, hd(!linePos)))
      end
...
fun yyAction45 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.ID(yytext, !lineNum, hd(!linePos)))
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction45(strm, yyNO_MATCH)
                      else yyQ36(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ36(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ36(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
...
fun yyQ17 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ85(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
...
fun yyQ15 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction17(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ87(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
